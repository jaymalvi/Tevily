   ...
   <body>
            ...
            <div class="row">
               ...
               <div class="col-sm-6">
                  <div class="float-right text-center d-flex">
                     ...
                     <div class="ml-5 pl-5">
                        <a href=""><button type="button" class="btn1" style="height:45px;">BECOME A LOCAL GUIDE</button></a>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="container-fluid">
        <div class="container">
           <div class="home_destination my-4">
              <p>Home - <span style="color:#e8604c">News</span></p>
           </div>
        </div>
        <hr/>
     </div>
     <div class="container-fluid">
         <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4">
                   <div class="section_title_img_">
                      <img src="images/news-page-1.jpg"alt="news" class="img-fluid">
                      <div class="section_date news_date">
             ...
             <div class="row">
                ...
                <div class="col-sm-4">
                   <div class="section_title_img_">
                      <img src="images/news-one-img-3.jpg"alt="news" class="img-fluid">
                      <div class="section_date news_date news_right">
                         <p class="text-center">28<br>Aug</p>
                      </div>
                   </div>
                   <div class="section_title_content">
