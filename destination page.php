...
<body>
    <div class="container-fluid bg-dark top_class">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="header d-flex mt-3 pt-1">
                        <div class="">
                ...
                <div class="col-sm-6">
                    <div class="float-right text-center d-flex">
                        ...
                        <div class="ml-5 pl-5">
                           <button type="button" class="btn1" style="border-radius:none !important;margin-top:-5px;height:58px;padding-top:13px">BECOME A LOCAL GUIDE</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
      <div class="container">
        <div class="home_destination my-4">
          <p><a href="index.html" class="text-reset">Home</a> - <span style="color:#e8604c"><a href="destination page.html" class="text-reset">Destination</a></span></p>
        </div>
      </div>
      <hr/>
    </div>
    <div class="container-fluid all_img">
      <div class="container">
        <div class="row">
          <div class="col-sm-3"data-aos="fade-left">
              <div class="destinationa_single_img">
                  <div class="Destination_img">
                      <img src="images/destination-1-1.png" alt="spain img" class="img-fluid">
          ...
          <div class="col-sm-6"data-aos="fade-down" style="padding-right:0px;padding-left:0px;">
              <div class="destinationa_single_img">
                  <div class="Destination_img">
                      <img src="images/destination-1-2.png">
                      <div class="destination_content">
                          <p>Wildlife</p>
                          <h2>Spain</h2>
                      </div>
          ...
          <div class="col-sm-3" data-aos="fade-right" style="padding-left:10px;">
              <div class="destinationa_single_img">
                  <div class="Destination_img">
                      <img src="images/destination-1-3.png">
                      <div class="destination_content">
                          <h2>Affrica</h2>
                      </div>
                  </div>
      ...
      <div class="row">
          ...
          data-aos-offset="300"
          data-aos-easing="ease-in-sine" style="padding-right:0px;">
              <div class="destinationa_single_img">
                  <div class="Destination_img">
          ...
          data-aos-offset="300"
          data-aos-easing="ease-in-sine" style="padding-left:10px;">
              <div class="destinationa_single_img">
                  <div class="Destination_img">
                      <img src="images/destination-1-5.png">
                      <div class="destination_content">
                          <p>Adventure</p>
                          <h2>Switerzland</h2>
                      </div>
      ...
      <div class="row">
        <div class="col-sm-3"data-aos="flip-left">
          <div class="destinationa_single_img end_img">
              <div class="Destination_img">
                  <img src="images/destination-1-6.png">
                  <div class="destination_content">
        ...
        <div class="col-sm-6" style="padding-left:0px;padding-right:0px;">
          <div class="destinationa_single_img"data-aos="fade-down"
          data-aos-anchor-placement="center-center">
              <div class="Destination_img">
                  <img src="images/destination-1-7.png">
                  <div class="destination_content">
                      <h2>San Francisco</h2>
                  </div>
              </div>
          </div>
          <div class="destinationa_single_img"data-aos="fade-up"
          data-aos-anchor-placement="bottom-bottom">
            <div class="Destination_img">
                <img src="images/destination-1-9.png">
                <div class="destination_content">
                    <h2>Germany</h2>
                </div>
            </div>
        ...
        <div class="col-sm-3" style="padding-left:10px;">
          ...
          data-aos-anchor-placement="center-bottom">
              <div class="Destination_img">
                  <img src="images/destination-1-8.png">
                  <div class="destination_content">
                    <p>Tours</p>
                      <h2>China</h2>
                  </div>
            ...
            data-aos-anchor-placement="center-bottom">
              <div class="Destination_img">
                  <img src="images/destination-1-10.png">
                  <div class="destination_content">
                      <h2>Dubai</h2>
                  </div>
              </div>
  ...
  <div class="container-fluid">
    <div class="foter top_of_footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="foter_logo"data-aos="fade-up"
        ...
        <div class="main_social_div d-flex"data-aos="zoom-out">
